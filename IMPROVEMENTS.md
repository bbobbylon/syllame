...
2. Generic login error message (1.4) and success feedback on Register (3.3).
3. Replace the CRA placeholder icons (3.9) and decide on the UI library question (3.7).
4. Server-side PDF export (2.5) if the browser print dialog is not enough.
5. Password reset / email verification (2.6) once real users sign up.
